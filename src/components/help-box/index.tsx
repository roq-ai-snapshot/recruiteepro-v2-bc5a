...
export const HelpBox: React.FC = () => {
  ...
  const applicationName = 'RecruiteePro v2';
...
3. Hiring Manager:
   a. As a hiring manager, I want to be able to review candidate profiles and resumes, so that I can make informed decisions about who to interview.
   b. As a hiring manager, I want to be able to provide feedback on candidates after interviews, so that we can make the best hiring decisions.
   c. As a hiring manager, I want to be able to collaborate with recruiters and admins on the platform, so that we can streamline the hiring process.
   d. As a hiring manager, I want to be able to track the progress of job openings, so that I can ensure we are meeting our hiring goals.
...
4. Admin:
   ...
   b. As an admin, I want to be able to configure the platform's settings and integrations, so that it aligns with our organization's processes and systems.
   c. As an admin, I want to be able to troubleshoot and provide support to other team members, so that they can effectively use the platform.
...
5. Job Applicant:
   ...
   b. As a job applicant, I want to be able to upload my resume and other relevant documents, so that recruiters and hiring managers can review my qualifications.
   c. As a job applicant, I want to be able to track the status of my application, so that I can stay informed about my progress in the hiring process.
   d. As a job applicant, I want to be able to receive notifications about new job openings and application updates, so that I can stay engaged with the organization.`;
